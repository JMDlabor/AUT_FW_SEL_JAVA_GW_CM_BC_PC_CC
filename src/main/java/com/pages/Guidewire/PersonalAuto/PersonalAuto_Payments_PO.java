...
public interface PersonalAuto_Payments_PO {
	...
	final By PA_PA_TotalPremium = By.xpath(
			"//div[contains(@id,'PremiumSummaryInputSet-TotalPremium')]//div[@class='gw-value-readonly-wrapper']");
	final By PA_PA_TaxesSurcharges = By.xpath(
			"//div[contains(@id,'PremiumSummaryInputSet-TotalTaxesSurcharges')]//div[@class='gw-value-readonly-wrapper']");
	final By PA_PA_Fees = By.xpath(
			"//div[contains(@id,'PremiumSummaryInputSet-InstallmentFees')]//div[@class='gw-value-readonly-wrapper']");
	final By PA_PA_TotalCost = By
			.xpath("//div[contains(@id,'PremiumSummaryInputSet-TotalCost')]//div[@class='gw-value-readonly-wrapper']");
	...
	final By PA_I_Frequency = By.xpath(
			"//div[contains(@id,'InvoiceStreamInputSet-InvoiceFrequency')]//div[@class='gw-value-readonly-wrapper']");
	final By PA_I_FixInvoicesby = By.xpath(
			"//div[contains(@id,'InvoiceStreamInputSet-FixInvoicesBy')]//div[@class='gw-value-readonly-wrapper']");
	final By PA_I_InvoicingDay = By.xpath(
			"//div[contains(@id,'InvoiceStreamInputSet-DayOfMonth')]//div[@class='gw-value-readonly-wrapper']");
	final By PA_I_PayUsing = By.xpath(
			"//div[contains(@id,'InvoiceStreamInputSet-PayUsing')]//div[@class='gw-value-readonly-wrapper']");
	...
	final By PA_B_BillingLevel = By.xpath(
			"//div[contains(@id,'BillingPanel-BillingLevel')]//div[@class='gw-value-readonly-wrapper']");
	final By PA_B_BillingMethod = By.xpath("//select[contains(@name,'BillingPanel-BillingMethod')]");

	/*
	 * Alternate Billing Account
	 */
	final By PA_B_AlternateBillingAccount = By
	...
	final By PA_B_BC_ExistingBillingContacts = By
			.xpath("//div[contains(@id,'ExistingBillingContact')]//div[@class='gw-label']");
	final By PA_B_BC_OtherContacts = By
	...
	final By PA_B_IO_Description = By
			.xpath("//input[contains(@name,'BillingInvoiceStreamInputSet-InvoiceStreamDescription')]");
	 ...
	 * Demo Payment System
	 */
	final By DPS_PolicyTransactionNumber = By
