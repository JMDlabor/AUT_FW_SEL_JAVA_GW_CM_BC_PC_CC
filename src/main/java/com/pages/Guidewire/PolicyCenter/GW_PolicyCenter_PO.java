...
public interface GW_PolicyCenter_PO {
    ...
    final By Bind_Options_Issue_Policy = By.xpath("//div[contains(@id,'BindOptions')]//div[3]//div[contains(@id,'BindAndIssue')]");
    /*
    ...
    */
     ...
     */
    final By NewSubmissions_PALob_Button = By.xpath("//div[@id=\"NewSubmission-NewSubmissionScreen-ProductOffersDV-ProductSelectionLV-8-addSubmission\"]");
    final By PAuto_NewSubmission_Offering = By.xpath("//select[contains(@name,'SubmissionWizard-OfferingScreen-OfferingSelection')]");
    ...
    final By Create_Vehicle = By.xpath("//div[@id='SubmissionWizard-LOBWizardStepGroup-LineWizardStepSet-PAVehiclesScreen-PAVehiclesPanelSet-VehiclesListDetailPanel_tb-Add']");
